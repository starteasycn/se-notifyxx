...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "notifyxx@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "notifyxx API";

        private String description = "notifyxx API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "notifyxx";
